...
import { AppWindow, ArrowUpRight, Blocks, DatabaseZap, Globe2, type LucideIcon } from "lucide-react";
...
const serviceIconStyles: Record<ServiceIconKey, { badgeTone: string; iconColor: string }> = {
